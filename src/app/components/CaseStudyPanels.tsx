      ...
      <div>
        ...
        <PanelSection label="The Insight">
          ...
          >
            ...
            Simplifying the interaction model — progressive flows, clearer
            visual hierarchy — turned a confusing arrival into a legible one.
          </p>
        </PanelSection>
      </div>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64 }}>
      <div>
        ...
        <PanelSection label="What I Did">
          ...
          >
            ...
            comparable portals and ran open-ended interviews with users who'd
            hit friction firsthand. Cognitive load mapping showed where the
            interface was asking too much at once.
          </p>
          <div style={{ marginTop: 16 }}>
      ...
      <div>
        ...
        <PanelSection label="Key Insight">
          ...
          >
            The cognitive load wasn't in the number of steps — it was in the
            mismatch between the system's assumptions and the user's lived
            experience. Simplification alone wouldn't have solved it. Reframing
            the entry points did.
          </p>
        </PanelSection>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64 }}>
      <div>
        ...
        <PanelSection label="What I Did">
          ...
          >
            Over roughly seven weeks, I conducted ~100 stakeholder interviews
            with payers, physicians, and decision-makers — mapping workflows and
            listening for where adoption was actually breaking down.
          </p>
          <div style={{ marginTop: 16 }}>
      ...
      <div>
        ...
        <PanelSection label="The Insight">
          ...
          >
            The barrier wasn't the drug. It was the workflow around it. That
            reframe changed how the product positioned itself — and earned Best
            in Show at the NIH I-Corps program.
          </p>
        </PanelSection>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64 }}>
      ...
      <div>
        <PanelSection label="Design Principles">
          ...
          >
            Show only what the user needs right now. Use visual hierarchy
            instead of written instructions wherever possible. Treat waiting as
            a designed moment, not dead time.
          </p>
        </PanelSection>
